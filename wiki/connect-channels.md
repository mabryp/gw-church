...
- **Google Calendar embed** on homepage: public calendar id
  `b3458b987ae80eea19b5c70f6c6600a8c6f4475fff1ef61c46686c33e0caa559@group.calendar.google.com`
  (America/Chicago). Platform-independent — can be re-embedded on the new site.
- **Google Maps embed** on homepage: pin at 6623 Five Palms Dr (29.367089,
  -98.615837, zoom 17).

Note: the homepage's "social media" link is broken (see lint findings in
